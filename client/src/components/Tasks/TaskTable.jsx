...
import { BGS, TASK_TYPE, PRIOTITYSTYELS, formatDate } from "../../utils/utility";
...
const TaskTable = ({ tasks }) => {
  ...
  const TableHeader = () => (
    <thead className='w-full border-b border-gray-300'>
      <tr className='w-full text-black  text-left'>
        <th className='py-2 text-center'>Task Title</th>
  ...
  return (
    <>
      <div className='bg-white px-2 md:px-4 pt-4 shadow-md rounded-xl'>
